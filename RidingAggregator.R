...
data <- read.csv("Data/42ResultsRAW/42PollLocations.csv", header = TRUE, sep = ",")
...
ReadAddress <- paste0("Data/42ResultsRAW/pollresults_resultatsbureau",i,'.csv') #Generates string that iterates through CSV list
print(ReadAddress)
...
df_located <- read.csv("Data/CAN42Tag.csv")
...
write.csv(Results42, file = "Data/42Results.csv", row.names = FALSE)
...
data <- read.csv("Data/41ResultsRAW/41PollLocations.csv", header = TRUE, sep = ",")
...
candidates <- read_csv("Data/41ResultsRAW/table_tableau12.csv", locale = locale(encoding = "ISO-8859-1"))
...
ReadAddress <- paste0("Data/41ResultsRAW/pollbypoll_bureauparbureau",i,'.csv') #Generates string that iterates through CSV list
...
association <- read_csv("Data/41ResultsRAW/table_tableau11.csv", locale = locale(encoding = "ISO-8859-1"))
...
write.csv(Results41, file = "Data/41Results.csv", row.names = FALSE)

#Write dictionary for 41st election
write.csv(Dictionary41, file = "Dictionaries/41Dictionary.csv", row.names = FALSE)


#Write dictionary for 42nd election
write.csv(Dictionary42, file = "Dictionaries/42Dictionary.csv", row.names = FALSE)
